...
class Order(Base):
    ...
    delivery_method: Mapped[str] = mapped_column(String(40), nullable=False, default="RETIRADA")
    delivery_service: Mapped[str] = mapped_column(String(80), nullable=False, default="Retirada na loja")
    delivery_price: Mapped[Decimal] = mapped_column(Numeric(10, 2), nullable=False, default=Decimal("0.00"))
    delivery_deadline: Mapped[str] = mapped_column(String(80), nullable=False, default="Disponível em até 1 dia útil")
    delivery_zipcode: Mapped[str | None] = mapped_column(String(12), nullable=True)
    delivery_city: Mapped[str | None] = mapped_column(String(80), nullable=True)
    delivery_state: Mapped[str | None] = mapped_column(String(2), nullable=True)
...
class ContactMessage(Base):
    ...
    assunto: Mapped[str | None] = mapped_column(String(120), nullable=True)
