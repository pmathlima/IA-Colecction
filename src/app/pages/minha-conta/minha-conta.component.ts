...
export class MinhaContaComponent implements OnInit {
  ...
  protected readonly customerName = computed(() => this.customer()?.nome ?? 'Cliente IA Collection');
  ...
  loadProfile(): void {
    ...
    this.authService
      ...
      .subscribe({
        next: () => this.fillForm(),
        error: () => this.feedbackService.show('Não foi possível carregar seus dados.', 'error'),
      });
  }
  ...
  submit(): void {
    ...
    this.authService
      ...
      .subscribe({
        next: () => this.feedbackService.show('Dados atualizados com sucesso.', 'success'),
        error: () => this.feedbackService.show('Não foi possível atualizar seus dados.', 'error'),
      });
  }
